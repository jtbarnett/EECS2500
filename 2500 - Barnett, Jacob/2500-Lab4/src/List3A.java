...
//Written by Jacob Barnett on 11/18/2019
...
public class List3A extends WordCounter implements PerformanceTraceable
{
    ...
    {
    	//this method either increments the count of the word if it appears and moves it to the front of the list
    	//or adds the node to the front of the list
