...
//this is the second hash table word counter. In this counter we will be hashing the
//the input string (i.e. each word of each line of the text file). We will be hashing the input
//string with the hash function that takes the first character of the input string
public class HashTableList2 extends WordCounter implements PerformanceTraceable
{
	...
	public int hashFunction(String word)
	{
		...
		//which index of the array the word should be added to. This hash takes the character value of the
